...
export interface ApiCadetCadet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    completions: Schema.Attribute.Relation<
      'oneToMany',
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::cadet.cadet'> &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiChallengeChallenge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    difficulty: Schema.Attribute.String & Schema.Attribute.DefaultTo<'medium'>;
...
export interface ApiCompletionCompletion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cadet: Schema.Attribute.Relation<'manyToOne', 'api::cadet.cadet'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    cadet: Schema.Attribute.Relation<'oneToOne', 'api::cadet.cadet'>;
